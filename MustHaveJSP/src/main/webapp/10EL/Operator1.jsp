...
<body>
	...
	<!-- 
		톰켓 8.0 부터는 EL에서 변수할당을 할 수 있다. 하지만 변수할당과 동시에
		출력되므로, 할당문 뒤에 ;'' 를 붙여줘야 출력되지않는다.
		즉, EL에서 
	 -->
	...
	num1 * num2 : ${ num1 * num2 } <br />
	<!--
		 나눗셈에서 /와 div연산자를 사용할 수 있다. 또한 자동형 변환이 적용되므로
	...
	<!-- EL에서는 +덧셈연산만 가능하고, 문자열의 연결에는 사용되지않는다. -->
	<h3> + 연산자는 덧셈만 가능</h3>
	num1 + "34" : ${ num1 + "34" } <br/>
	<!-- 
