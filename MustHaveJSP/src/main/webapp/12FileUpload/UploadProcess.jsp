...
try {
   ...
   */
   ...
   /*
   		서버에 저장된 파일의 파일명을 새로운파일명으로 변경해준다.
   		여기서 사용된 separator는 경로를 표시할 때 사용하는 구분기호로 
   		윈도의 경우 \(역슬래쉬), 리눅스의 경우 /(슬러쉬)를 자동으로 부여해준다.
   		File 객체를 각각 생성한 후 renameTo()메서드를 통해 변경한다.
   */
   ...
   /*
   		...
   		mr 객체를 통해 받아야하므로 주의해야한다. 객체는 다르지만 폼값을 받기위해 
   		메서드명은 동일하다 
   */
   ...
   dao.insertFile(dto);
   // 자원반납 (커넥션 풀에 Connection객체를 반납한다.)
   dao.close();
