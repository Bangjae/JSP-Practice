...
/*
	page 영역 : 하나의 페이지에서만 영역이 공유되고 페이지 이동, 포워드 된 페이지에서는
...
/*
	...
	Object를 기반으로 저장되므로 차후 값을 읽을 때만 해당 타입으로 형변환 해야한다.
*/
%>
<!DOCTYPE html>
<html>
...
<body>
	...
	<!--  
		...
		공유되지않는다 즉 아래의 링크를 통해 이동한 페이지에서는 아무런 내용이
		출력되지않는다.
	 -->
