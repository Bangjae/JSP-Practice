...
<body>
	<!-- 
		쿠키 : 클라이언트의 상태정보를 유지하기 위한 기술로 클라이언트의 pc파일 형태로
		저장된다. 쿠키하나의 크기는 4kb이고, 3000개까지 만들 수가 있습니다.
	 -->
	<h2>1. 쿠키(Cookie) 설정</h2>
	<%
	/*
		쿠키는 생성자를 통해서만 생성할 수 있다. setName()이란 메서드가 없으므로
		쿠키는 생성한 후 쿠키명을 변경하는 것을 불가능하다.
	*/
	Cookie cookie = new Cookie("myCookie", "쿠키맛나요"); //쿠키생성
	/*
		쿠키의 경로 설정. 컨텍스트루트 경로로 지정하므로 웹어플리케이션 전체에서
		사용할 수 있게 된다.
	*/
	...
	*/
	...
	<%
	/*
		request 내장 객체의 getCookies()를 통해 현재 생성된 모든 쿠키를 배열의 형태로
		가져온다.
	*/
