...
<body>
	...
	<!-- 
		...
		디렉토리 하위에 프로젝트와 동일한 톰켓 환경을 만들어서 복사본 파일을 실행한다.
		따라서, 아래의 물리적경로는 .metadata 하위의 경로가 출력된다.
 	-->
	...
	*/
	public String useImplicitObject(){
		/*
			방법1: getServiletContext() 메서드를 통해 선언부에서 application 
			내장 객체를 매개변수로 전달해서 사용한다.
		*/		
		return this.getServletContext().getRealPath("/02ImplicitObject"); 
	}
	public String useImplicitObject(ServletContext app){
		/*
			방법2: 스트립틀릿에서 메서드를 호출할 때 application 내장객체를 매개변수로
			전달해서 사용한다.
		*/
