...
public class LifeCycle extends HttpServlet
{
	/*
	 	...
	 	따라서 메서드명은 개발자가 결정하면된다. init()메서드가 호출되기 전 전처리를
	 	위해 주로 사용한다.
	*/
   @PostConstruct
   ...
   /*
     	서블릿 객체 생성 후 딱 한번만 호출되는 메서드로, 보통 서블릿을 초기화하는 역할.
    */
   @Override
   ...
   */
         ...
         throws ServletException, IOException
   {
      ...
      /*
       		service() 메서드에서 요청방식을 분석한 후 각 메서드를 호출할 떄
       		별도로 호출문장을 기술하지 않는다. 단지 아래의 문장이면 된다.
       */
