...
public class EditController extends HttpServlet
{
		...
		throws ServletException, IOException
	{
		...
		// hidden 박스에 저장된 내용(게시물 수정 및 파일수정에 필요함)
		...
		/*
		 	패스워드의 경우 인증완료 시 session영역에 저장해 둔것을 얻어온다.
		 	update 쿼리 실행 시 where에 조건으로 추가된다.
		...
		*/
		...
		if(fileName != null)
		{
			...
			// 파일객체 생성 후 파일명을 변경한다.
			File oldFile = new File(savaDirectory + File.separator + fileName);
			File newFile = new File(savaDirectory + File.separator + newFileName);
