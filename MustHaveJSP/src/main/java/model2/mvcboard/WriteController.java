...
/*
 	글쓰기 페이지로 진입 시에는 단순한 페이지 이동이므로 doGet()이 요청을 처리한다.
 	즉, 글쓰기 페이지만 보여주면 된다.
*/
			...
			throws ServletException, IOException
	{
		...
		*/
		...
		/*
		 	...
		 	디렉토리의 경로를 확인해본다.
		 	만약에 글 작성시 파일을 첨부하지 않았더라도 객체는 생성되므로 폼값은 
		 	정상적으로 받을 수 있다.
		*/
		if (mr == null)
		{
